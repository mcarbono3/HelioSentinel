...
const Dashboard = () => {
  ...
  return (
    // Contenedor principal ahora con 'flex' para diseño de barra lateral
    <div className="flex min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
      ...
      {/* 'flex-1' para que ocupe el espacio restante, 'p-4' para padding, 'overflow-y-auto' para desplazamiento vertical */}
      {/* 'md:ml-64' añade un margen izquierdo en pantallas medianas y grandes para hacer espacio a la barra lateral de 64 unidades */}
